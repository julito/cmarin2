    ...
    <div class="wrapper">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item menu-close">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo $URL; ?>especialidades" class="nav-link ">
                                        <i class="far fa-circle nav-icon"></i>
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item menu-close">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo $URL; ?>especialistas" class="nav-link ">
                                        <i class="far fa-circle nav-icon"></i>
        ...
        <div class="content-wrapper">
            ...
            if (isset($_GET['ruta'])) {
               ...
               $rutaURL= explode('/',$_GET['ruta']);
               $modelo=ucfirst(array_shift($rutaURL));

               $rutaModelo= RUTA_MODULOS . $modelo . ".php";
               //echo $rutaModelo;
            if (file_exists($rutaModelo)) {
                include "Vistas/Modulos/".$modelo . ".php";
            } else {
